 ...
 * @param[in, out] fs
 * @param[in] aid Buffer containing the AID.
 * @param[in] pix_len Length of the PIX component of the AID (the RID is always
 * the same length and the AID buffer must be guaranteed to contain at least the
 * RID plus as many PIX bytes as have been specified here).
 * @return Return code.
 ...
 * @param[in, out] fs
 * @param[in] df_name The name to look for in all DFs. No need for it to be
 * NULL-terminated.
 * @param[in] df_name_len Length of the DF name string.
 * @return Return code.
 */
 ...
 * @param[in, out] fs
 * @param[in] sid Short file identifier.
 * @return Return code.
 ...
 * @param[in, out] fs
 * @param[in] path Buffer which must be a concatenation of file IDs.
 * @return Return code.
 */
 ...
 * file.
 * @param[in, out] fs
 * @param[in] idx Record number/index.
 * @return Return code.
 */
 ...
 * @param[in, out] fs
 * @param[in] offset_prel Parent-relative offset in the transparent buffer.
 * @return Return code.
 */
